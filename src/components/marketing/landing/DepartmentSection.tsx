      ...
      >
        ...
        >
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-gray-300 sm:text-md lg:text-xl xl:text-xl leading-relaxed font-jersey">
              ...
              <div key={idx} className="glassmorphism p-2 sm:p-3 lg:p-4 rounded-lg">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center space-x-2">
                    <span className="font-jersey text-base sm:text-lg text-white">{item.label}</span>
                  </div>
                  <span className="text-[10px] sm:text-sm px-2 py-0.5 rounded bg-cyan-500/20 text-cyan-300 border border-cyan-400/40 whitespace-nowrap">
                    {item.metric}
                  </span>
                </div>
              </div>
            ...
            <div className="pixel-office-room w-full h-full relative">
              ...
              <div className="absolute top-8 left-8">
                <div className="glassmorphism px-3 py-2 rounded border border-cyan-400">
                  <span className="text-xl text-cyan-400 font-jersey">AI Active</span>
                </div>
              </div>

              <div className="absolute top-8 right-8">
                <div className="glassmorphism px-3 py-2 rounded border border-green-400">
                  <span className="text-xl text-green-400 font-jersey">Online</span>
                </div>
              </div>

              <div className="absolute bottom-8 left-8">
                <div className="glassmorphism px-3 py-2 rounded border border-purple-400">
                  <span className="text-xl text-purple-400 font-jersey">{`Efficiency: ${efficiency.toFixed(1)}%`}</span>
                </div>
              </div>

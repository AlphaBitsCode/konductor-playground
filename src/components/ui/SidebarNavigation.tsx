...
export default function SidebarNavigation() {
  ...
  return (
    <div className={`h-full flex flex-col transition-all duration-300 ${
    ...
    } dark:bg-slate-900/90 bg-stone-100/90 backdrop-blur-sm border-r-2 dark:border-slate-600 border-stone-300`}>
      {/* Header */}
      <div className="p-4 border-b-2 dark:border-slate-600 border-stone-300">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
            ...
            {!isCollapsed && (
              <div>
                <span className="dark:text-white text-stone-800 font-press-start text-sm block">
                  Konductor
                </span>
                <span className="dark:text-slate-400 text-stone-600 font-jersey text-xs">
                  Office Portal
                </span>
              </div>
            )}
      ...
      <div className="p-4 border-t-2 dark:border-slate-600 border-stone-300">
